...
import { TextField, Popover, Typography, Box, IconButton, Menu, MenuItem, Button } from '@mui/material';
            ...
            >
                <Box sx={{ padding: 2, maxWidth: 300 }}>
                    ...
                    <Box sx={{ marginTop: 2 }}>
                        ...
                        <TextField placeholder="Rango 1" size="small" fullWidth margin="normal" />
                        <TextField placeholder="Rango 2" size="small" fullWidth margin="normal" />
                    </Box>
                    <Box sx={{ marginTop: 2 }}>
                        <Typography variant="body1">Hábitat</Typography>
                        <TextField placeholder="Escribe hábitat" size="small" fullWidth margin="normal" />
                    </Box>
                    <Box sx={{ marginTop: 2 }}>
                        <Typography variant="body1">Clima</Typography>
                        <TextField placeholder="Escribe clima" size="small" fullWidth margin="normal" />
                    </Box>
                    <Box sx={{ marginTop: 2 }}>
                        <Typography variant="body1">Ubicación</Typography>
                        <TextField placeholder="Escribe ubicación" size="small" fullWidth margin="normal" />
                    </Box>
                </Box>
            </Popover>
        </div>
